...
EVENT_KINDS = ("normal", "birthday", "immutable")
...
class CalendarEvent(Base):
    ...
    # normal | birthday | immutable — birthday implies yearly recurrence + birthday ladder
    event_kind: Mapped[str] = mapped_column(String(16), nullable=False, default="normal")
