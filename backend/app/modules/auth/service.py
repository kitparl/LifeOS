...
class AuthService:
    ...
    async def register(self, data: RegisterRequest):
        ...
        try:
            ...
            raise ConflictError("Email or username already registered",) from None
    ...
    async def update_profile(self, user_id: str, data: UserUpdateRequest):
        user = get_or_404(await self.repo.get_by_id(user_id), "User not found")
